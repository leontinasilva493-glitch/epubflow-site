...
export enum Routes {
  ...
  EpubToKindle = '/epub-to-kindle',
  EpubToMarkdown = '/epub-to-markdown',
  EpubToTxt = '/epub-to-txt',
  EpubToDocx = '/epub-to-docx',
  GuideMobiVsAzw3VsEpub = '/guides/mobi-vs-azw3-vs-epub',
  GuideBestEbookFormatForKindle = '/guides/best-ebook-format-for-kindle',
  About = '/about',
  Contact = '/contact',
  Waitlist = '/waitlist',
  Changelog = '/changelog',
